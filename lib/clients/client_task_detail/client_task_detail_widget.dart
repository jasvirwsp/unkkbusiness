...
class ClientTaskDetailWidget extends StatefulWidget {
  const ClientTaskDetailWidget({super.key});
...
class _ClientTaskDetailWidgetState extends State<ClientTaskDetailWidget> {
  ...
  void initState() {
    ...
    _model.assigneeController1 ??= TextEditingController();
    _model.assigneeFocusNode1 ??= FocusNode();
    ...
    _model.assigneeController2 ??= TextEditingController();
    _model.assigneeFocusNode2 ??= FocusNode();
  }
                                      ...
                                      child: Padding(
                                        ...
                                        child: SizedBox(
                                          height: MediaQuery.sizeOf(context)
                                                  .height *
                                              1.0,
                                          child: const AddClientTaskWidget(),
                                        ),
                                      ),
                                    );
                                  },
